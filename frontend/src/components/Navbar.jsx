...
const Navbar = () => {
  ...
  return (
    <nav className='flex items-center max-w-screen w-full justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white fixed transition-all'>
